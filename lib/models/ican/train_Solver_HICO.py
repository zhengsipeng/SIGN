...
class SolverWrapper(object):
    ...
    def __init__(self, sess, network, Trainval_GT, Trainval_N, output_dir, tbdir, Pos_augment, Neg_select, Restore_flag,
        ...
        self.net = network
        #self.Trainval_GT = self.change_form(Trainval_GT, interval_divide=5)
    ...
    def change_form(self, Trainval_GT, interval_divide):
        # cluster pairs in one image together, the max pair num of each = interval_divide
        GT_dict = {}
